...
| C2 | Customer, device và repair order | IN PROGRESS — c2-000/c2-001 DONE; c2-002 → c2-004 → c2-005 → c2-006 → c2-007 → c2-008 → c2-009 READY | [C2 area-first implementation plan](./c2/README.md) |
